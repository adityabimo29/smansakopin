<?php $this->layout('template', ['hal'=>'Produk Kategori']) ?>
<?php
	...
	<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM produk_kategori WHERE id_produk_kategori='$_GET[id]'");
			  ...
			  <div class="row">
				...
				<div class="col-md-12 card">
				  ...
				  <div class="ccard-body">
					<!-- form start -->
					<form role="form" action="modul/produk_kategori/aksi.php?module=<?php echo $module; ?>&act=update" method="POST" enctype="multipart/form-data" >
						<input type="hidden" name="id_produk_kategori" value="<?php echo $tedit['id_produk_kategori']; ?>">
