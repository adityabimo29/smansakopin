                ...
                <form role="form" action="produk" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Harga Normal</label>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_produk_kategori">
                                        ...
                                        <option value="<?= $row['id_produk_kategori'] ?>"
                                            <?=($row['id_produk_kategori'] == $data['id_produk_kategori'] )? 'selected' : '' ?>>
                                            <?= $row['judul'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="stok" class="form-control">
                                        ...
                                        <option value="Pre Order"
                                            <?php echo ($data['stok'] == 'Pre Order')? 'selected' : '' ?>>Pre Order
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Promo</label>
                                    <select name="promo" class="form-control">
                                        <option value="Tidak" <?php echo ($data['promo'] == 'Tidak')? 'selected' : '' ?> >Tidak</option>
                                        <option value="Ya" <?php echo ($data['promo'] == 'Ya')? 'selected' : '' ?>>Ya</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-sm btn-primary mb-2"
                                        href="produk-size-add-<?=$data['id_produk']?>"><i
                                    ...
                                    <div class="table-responsive">
                                        <table id="my_table2" class="table table-sm table-bordered">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th width="2%" class="center">No</th>
                                                    <th width="30%" class="center">Size </th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while($r = $size->fetch(PDO::FETCH_ASSOC)){
                                                ?>
                                                <tr>
                                                    <td width="10%" align="center"><?php echo  $no; ?></td>
                                                    <td><?php echo  $r['judul']; ?></td>
                                                    <td width="20%" align="center"><?php echo  $r['harga']; ?></td>
                                                    <td align="center" width="20%">
                                                        <a href="<?php echo $module; ?>-size-edit-<?php echo $r['id_produk_size']; ?>"
                                                            class="btn btn-warning btn-sm " role="button" aria-pressed="true"
                                                            style=""> <i
                                                                class="fa fa-pencil"></i>
                                                            </a>
                                                        <a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');"
                                                            href="<?php echo $module; ?>-size-delete-<?php echo $r['id_produk_size']; ?>"
