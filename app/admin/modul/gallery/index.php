...
<?php
	...
	switch($act){
        case "list":
?>
<a href="gallery-add" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data</a>
<br><br>
    ...
    <table id="my_table" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="../images/gallery/small/<?php echo $row['gambar']; ?>"
                        style="width:100px;margin:0 auto;display:block">
                </td>
                <td style="width:19%"><a href="gallery-edit-<?php echo $row['id_gallery'] ?>"
                        class="btn btn-warning"> <i class="fas fa-pencil-alt"></i> Edit</a>
                    <a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');"
                        href="<?php echo $module; ?>-delete-<?php echo $row['id_gallery']; ?>"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Url</label>
                        <input type="text" class="form-control" name="nama" value="https://www.instagram.com/label_klambi/">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
...
<div class="card">
    <div class="card-body">
        <form action="gallery" id="form-gallery"  method="POST" enctype="multipart/form-data" >
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="" id="img-lopo">
                            <img style="height:200px" src="../images/gallery/small/<?php echo $data['gambar'] ?>">
                        </div>
                    </div>
                </div>
...
<?php
	...
	case "addgallery":
?>
<form action="modul/gallery/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
...
<?php
    break;
	case "editgallery":
	$gam =  $db->connection("SELECT * FROM gallery_gallery WHERE id_gallery = '$_GET[id]'  ")->fetch();
?>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <img style="height:300px"
                        src="../images/gallery_gallery/<?php echo $imgname2."-".$gam['gambar']?>">
                </div>
            </div>
        </div>
        <input type="submit" class="btn btn-info" value="Simpan Data">
