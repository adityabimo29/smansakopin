...
function sendEmail($data,$admin){
    try{
        ...
        $mail->SMTPDebug = 0;                     
        $mail->isSMTP();                                            
        $mail->Host       = 'mail.dijogja.co';                    
        $mail->SMTPAuth   = true;                                   
        $mail->Username   = 'enom@dijogja.co';                 
        $mail->Password   = 'jogjamediaweb';                               
        $mail->SMTPSecure = 'ssl';         
        $mail->Port       = 465;                                    

        //Recipients
        $mail->setFrom('admin@nommanagement.com', 'Enom Management');
...
<html>
	<head>
        <title>Contact Enom Management</title>
        ...
        <div class="wrapper">
            <div class="container">
                <div class="header">
                    ...
                    <span class="byline">'.$data['email'].'</span>
                </div>
                ...
                '.$data['message'].'
	                ...
	                <div class="privacy-policy">
	                    <p av:i18n="block"><a href="https://www.nommanagement.com">Enom Management</a></p>
	                </div>
            </div>
        </div>
    </body>
...
';
        ...
        $mail->Subject = 'Enom Management - '.$data['subject'];
        $mail->Body    = $pesan;
